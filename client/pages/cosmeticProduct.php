        ...
        <div class="container">
            <div class="row g-0 gx-5 align-items-end">
                <div class="col-lg-6">
                    <div class="section-header text-start mb-5 wow fadeInUp" data-wow-delay="0.1s"
                        ...
                        <h1 class="display-5 mb-3" style="font-family: 'Poppins', sans-serif;">Cosmetic Products</h1>

                    </div>
                </div>
                <?php
                    include("./partials/activeCosmeticProduct.php");
                ?>
            </div>
            <div class="tab-content">
                <div class="tab-pane fade show p-0 active">
                    <div class="row g-4">
                        <?php
                    include("./partials/cosmeticProductContents.php");
                ?>
